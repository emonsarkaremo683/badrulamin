    ...
    <body>
        <div class="container-wrapper">
            <div class="header-section">
                ...
                <a href="Add.jsp" class="btn-add-employee">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                <a href="${pageContext.request.contextPath}/student?action=edit&id=${emp.id}" class="btn-action btn-edit">
                                                    <i class="bi bi-pencil-square"></i> Edit
                                                </a>
                                                <a href="${pageContext.request.contextPath}/student?action=delete&id=${emp.id}" class="btn-action btn-delete" 
